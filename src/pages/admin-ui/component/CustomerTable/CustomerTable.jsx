...
const CustomerTable = () => {
  ...
  const AccountArrayData = Array.isArray(ListAccountData?.success?.data.data)
    ? ListAccountData?.success?.data.data
    : [];
  ...
  return (
    <div className="customer_table_container">
      <div className="customer_table_title">Người dùng</div>
      <div className="customer_table_header">
        <div className="customer_table_search_container">
          ...
          <input
            ...
            className="customer_table_search_input"
          />
        </div>

        <div className="customer_table_action_buttons">
          <button className="customer_table_export_button">
            <AiOutlineExport /> Export
          </button>
          <button className="customer_table_add_button">
            + Thêm người dùng
          </button>
        </div>
      </div>
      <div className="table-manage-customer-admin">
              ...
              <tr key={customer.id}>
                ...
                <td className="customer_table_info">
                  <img
                    src={customer.image}
                    alt={customer.image}
                    className="customer_table_avatar"
                  />
                </td>
                <td>
                  <a
                    href={`mailto:${customer.email}`}
                    className="customer_table_email_link"
                  >
                    {customer.email}
                  </a>
                </td>
