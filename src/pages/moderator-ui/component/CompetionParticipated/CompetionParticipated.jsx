...
import "./CompetionParticipated.css";

const CompetionParticipated = () => {
    const data = [
        {
            competitionId: 1,
            image:
    ...
    return (
        <div className="competition-participated">
            <div className="competition-participated-header">
                <h2 className="competition-participated-title">
...
export default CompetionParticipated;
