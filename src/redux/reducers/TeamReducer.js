...
export const updateTeamRegisterReducer = (state = {}, action) => {
    switch (action.type) {
        case UPDATE_TEAMS_REGISTER_REQUEST:
            return { loading: true };
        case UPDATE_TEAMS_REGISTER_SUCCESS:
            return { loading: false, success:true };
        case UPDATE_TEAMS_REGISTER_FAIL:
            return { loading: false, error: action.payload };
        case UPDATE_TEAMS_REGISTER_RESET:
            return {};
        default:
            return state;
    }
